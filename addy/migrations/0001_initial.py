# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-06-02 11:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eligiblity', models.CharField(default='none', max_length=1024)),
                ('name', models.CharField(max_length=200)),
                ...
                ('eligible_departments', models.ManyToManyField(to='addy.Department')),
            ],
        ),
        migrations.CreateModel(
            name='News',
